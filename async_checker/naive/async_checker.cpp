...
int main() {
    ...
    int p50 = latencies[static_cast<size_t>(NUM_TASKS * 0.50)];
    int p95 = latencies[static_cast<size_t>(NUM_TASKS * 0.95)];
    int p99 = latencies[static_cast<size_t>(NUM_TASKS * 0.99)];
